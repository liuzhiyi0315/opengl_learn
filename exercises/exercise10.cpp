...
void exercise10(GLFWwindow* window) {
    ...
    // Phong Shading
    auto vertexShaderSource = ParseShader("../res/shader/light/e10/e10_vertex.shader");
    auto fragmentShaderSource = ParseShader("../res/shader/light/e10/e10_fragment.shader");
    ...
    float _tmp = 1.0f;
    glUniform1fv(glGetUniformLocation(shaderProgram, "light.constant"), 1, &_tmp);
    _tmp = 0.09f;
    glUniform1fv(glGetUniformLocation(shaderProgram, "light.linear"), 1, &_tmp);
    _tmp = 0.032f;
    glUniform1fv(glGetUniformLocation(shaderProgram, "light.quadratic"), 1, &_tmp);
