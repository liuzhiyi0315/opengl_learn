...
void exercise14(GLFWwindow* window) {
    ...
    auto fragmentShaderSource = ParseShader("../res/shader/advanced/e14_fragment.shader");
    ...
    float vegeta_vertices[] = {
        ...
        0.1f, -0.1f, 0.0f, 1.0, 0,   0.0, 0.0, 1.0,// 右下角
        -0.1f, -0.1f, 0.0f, 0, 0,    0.0, 0.0, 1.0,// 左下角
        -0.1f, 0.1f, 0.0f,  0, 1.0,  0.0, 0.0, 1.0 // 左上角
    };
