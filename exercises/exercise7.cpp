...
void exercise7(GLFWwindow* window) {

    // object shader program

    // Phong Shading
    auto vertexShaderSource = ParseShader("../res/shader/light/e7/e7_vertex.shader");
    auto fragmentShaderSource = ParseShader("../res/shader/light/e7/e7_fragment.shader");
	...
	{       
        ...
        glm::vec3 lightPos(-2.0, 0.0f, 0.0f);
