...
void exercise8(GLFWwindow* window) {
    ...
    // Phong Shading
    auto vertexShaderSource = ParseShader("../res/shader/light/e8/e8_vertex.shader");
    auto fragmentShaderSource = ParseShader("../res/shader/light/e8/e8_fragment.shader");
    ...
    auto lightPos = glm::vec3(0.0f, 4.0f, 1.0f);
